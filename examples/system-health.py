	...
	Service(
	    ...
	    monitor=(
	        SystemInfo(
	            ...
	            success=(
	                LogResult(
	                    "myserver.system.mem=", extract=lambda r, _: r["memoryUsage"]
	                ),
	                LogResult(
	                    "myserver.system.disk=",
	                    extract=lambda r, _: reduce(max, r["diskUsage"].values()),
	                ),
	                LogResult(
	                    "myserver.system.cpu=", extract=lambda r, _: r["cpuUsage"]
	                ),
	            ),
	        ),
	        Delta(
